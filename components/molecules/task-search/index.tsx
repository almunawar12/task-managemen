...
export default function TaskSearch() {
    ...
    return (
        <>
            <input type="date" className='p-2 w-44 border-2 border-primary rounded-md' />
            <input type="date" className='p-2 w-44 ml-4 border-2 border-primary rounded-md' />
            <input type="text" className='p-2 w-44 ml-4 border-2 border-primary rounded-md' placeholder='Search Task' />
